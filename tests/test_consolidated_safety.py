"""Regression tests for the consolidated execution/admin safety hardening."""
...
from app import config, marketplace, signals, updater, watchdog
...
async def test_simple_partial_entry_failure_is_truthful(admin, monkeypatch):
...
async def _copy_runner(monkeypatch, broker_nets):
    ...
    runner = safety_runner.GroupRunner(1, group)
