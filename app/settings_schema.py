...
SCHEMA: dict[str, Field] = {
    ...
    "alert_telegram_enabled": Field("bool"),
    "alert_min_severity_telegram": Field("str", choices=("info", "warn", "critical")),
    "alert_escalation": Field("bool"),
    "alert_sms_to": Field("str", max_len=32, portable=False),
