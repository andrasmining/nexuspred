...
DE = {
    ...
    'All systems operational': 'Alle Systeme laufen',
    'Degraded performance': 'Eingeschränkter Betrieb',
    'Major outage': 'Grössere Störung',
    'Version': 'Version',
    'checked': 'geprüft',
    'Uptime': 'Laufzeit',
    'since the last restart': 'seit dem letzten Neustart',
    'Signal latency (1 h)': 'Signal-Latenz (1 h)',
    'signals': 'Signale',
    'no signals in the last hour': 'keine Signale in der letzten Stunde',
    'Brokers': 'Broker',
    'connected': 'verbunden',
    'partly connected': 'teilweise verbunden',
    'disconnected': 'getrennt',
    'No broker session is configured yet.': 'Noch keine Broker-Sitzung eingerichtet.',
    'Incidents': 'Störungen',
    'investigating': 'in Abklärung',
    'identified': 'Ursache erkannt',
    'monitoring': 'Beobachtung',
    'resolved': 'behoben',
    'No incidents in the last 7 days.': 'Keine Störungen in den letzten 7 Tagen.',
